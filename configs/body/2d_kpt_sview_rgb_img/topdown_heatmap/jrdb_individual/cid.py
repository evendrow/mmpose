...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/annotations/train_individual.json',
    ...
    val=dict(
        type='TopDownJRDBDataset',
        ann_file=f'{data_root}/annotations/val_individual.json',
        img_prefix=f'{data_root}/images/',
        data_cfg=data_cfg,
    ...
    test=dict(
        type='TopDownJRDBDataset',
        ann_file=f'{data_root}/annotations/test_individual.json',
